...
export const TwitterIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4 1.4-3.3 1.4H6.7c-3.3 0-3.3-3.3-3.3-3.3s1.7-1.4 3.3-1.4H15c4.4 0 6.7-6.7 6.7-6.7s-.7 .7-2 .7c-3.3 0-5-1.4-5-1.4s1.4-2 3.3-2c1.3 0 2.8.7 4.7.7Z" />
  </svg>
);
